...
function addMarkerToGroupb1(group, coordinate, html) {
  // var boy1 = new H.map.Marker(coordinate);
  var boy1 = new H.map.Marker(coordinate,{icon: new H.map.Icon('boy2.png')});
  // add custom data to the marker
  boy1.setData(html);
  group.addObject(boy1);
}

function addMarkerToGroupb2(group, coordinate, html) {
  // var boy1 = new H.map.Marker(coordinate);
  var boy2 = new H.map.Marker(coordinate,{icon: new H.map.Icon('boy1.png')});
  // add custom data to the marker
  boy2.setData(html);
  group.addObject(boy2);
}

function addMarkerToGroupl1(group, coordinate, html) {
  // var boy1 = new H.map.Marker(coordinate);
  var lady1 = new H.map.Marker(coordinate,{icon: new H.map.Icon('lady1.png')});
  // add custom data to the marker
  lady1.setData(html);
  group.addObject(lady1);
}

function addMarkerToGroupl2(group, coordinate, html) {
  // var boy1 = new H.map.Marker(coordinate);
  var lady2 = new H.map.Marker(coordinate,{icon: new H.map.Icon('lady2.png')});
  // add custom data to the marker
  lady2.setData(html);
  group.addObject(lady2);
}
...
function addInfoBubble(map) {
  ...
  addMarkerToGroupb1(group, {lat:17.4911, lng:78.5449},
    '<div>Mr.Boon ordered a Table</div>');

  addMarkerToGroupb2(group, {lat:17.4389, lng:78.5416},
    '<div >Mr.Aditya ordered a Apple</div>')

  addMarkerToGroupl1(group, {lat:17.4421, lng:78.5755},
    '<div >Ms.Anoohya ordered a Book</div>');

    addMarkerToGroupl2(group, {lat:17.4640, lng:78.5789},
    '<div >Girls like you</div>');
